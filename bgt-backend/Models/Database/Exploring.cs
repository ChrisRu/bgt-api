...
namespace BGTBackend.Models
{
    ...
    {
        [Column("verken_code")] public int Id { get; set; }

        [Column("project_code")] public int ProjectId { get; set; }

        [Column("m2_code")] public int? M2 { get; set; }
        ...
        [Column("einddatum_opgeleverd")] public DateTimeOffset? EndDateDelivered { get; set; }

        [Column("opmerking")] public string Remarks { get; set; }
    }
}